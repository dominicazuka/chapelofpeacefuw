...
const getChildrenSongs = async (req, res) => {
  try {
    const allChildrenSongs = await ChildrenSongsModel.findAll()
    return {
      error: false,
      message: 'Query Successfully',
      statusCode: 201,
      data: allChildrenSongs
    }
  } catch (error) {}
}

module.exports = { insertChildrenSongs, getChildrenSongs }
