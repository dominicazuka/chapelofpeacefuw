        ...
        <Table sx={{ minWidth: 650 }} aria-label='simple table'>
          <TableHead>
            <TableRow>
              ...
              <TableCell align='center'>Type of Membership</TableCell>
              ...
              <TableCell align='center'>Next of Kin Phone Number</TableCell>
              <TableCell align='center'>Next of Kin Address</TableCell>
              ...
              <TableCell align='center'>Holy Ghost Baptism</TableCell>
              <TableCell align='center'>Speaking in Tongues</TableCell>
          ...
          <TableBody>
            {rows.map((row, i) => (
              ...
              >
                ...
                <TableCell align='right'>{row.next_of_kin_name}</TableCell>
                <TableCell align='right'>{row.next_of_kin_phone_no}</TableCell>
                <TableCell align='right'>{row.next_of_kin_address}</TableCell>
                <TableCell align='right'>{row.born_again}</TableCell>
                <TableCell align='right'>{row.baptized}</TableCell>
                <TableCell align='right'>{row.baptism_method}</TableCell>
                <TableCell align='right'>{row.holy_ghost_baptism}</TableCell>
                <TableCell align='right'>{row.speaking_in_tongues}</TableCell>
