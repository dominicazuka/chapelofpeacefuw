...
const AlumniMembershipAdmin = lazy(() => import('./admin/pages/AlumniMemberships'))
const AlumniAnnouncement = lazy(() => import('./admin/pages/AlumniAnnouncement'))
        ...
        <div className="App" id={theme}>
          ...
          <main>
            <Routes>
              ...
              <Route path='/alumni-membership-admin' element={<AlumniMembershipAdmin />} />
              <Route path='/alumni-announcement-admin' element={<AlumniAnnouncement />} />
            </Routes>
          </main>
