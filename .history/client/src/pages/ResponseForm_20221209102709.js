...
function ResponseForm () {
  ...
  const [description, setDescription] = useState('student')
      ...
      >
        ...
        <Grid item xs={12} sm={12} md={5}>
          ...
          <Grid container direction='row' spacing={3}>
            <Grid item>
              <Checkbox
              checked={description === "student"}
              onChange={()=>setDescription("student")}
              />
            ...
            <Grid item>
              <Checkbox 
              checked={description === "staff"}
              onChange={()=>setDescription("staff")}
              />
