...
function Membership () {
  ...
  const [type_of_membership, setMembershipType] = useState('')
  ...
  const [born_again, setBornAgain] = useState('')
  const [baptized, setBaptized] = useState('')
  const [baptism_method, setBaptismMethod] = useState('')
  const [holy_ghost_method, setHolyGhostMethod] = useState('')
  const [speakingInTongues, setSpeakingInTongues] = useState('')
